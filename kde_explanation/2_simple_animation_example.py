...
def animate(frame):
    ...
    if frame == 0:
        ...
        ax.add_patch(circle)
    scat = ax.scatter(xs[frame], ys[frame], s=2, alpha=0.5, color='red', zorder=2)
    return scat,
...
if __name__ == '__main__':
    """ 
    Second attempt to create an animation of a circle “spilling out” like sand onto the ground
    ...
    save_path = Path(get_kde_plots_path(), "2_simple_animation.gif")
