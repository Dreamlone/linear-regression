...
def annotations_by_language(mode: str):
    if mode == "eng":
        title = "Frequency histograms with different numbers of bins (k)"
...
def plot_hist_explanation(mode: str = "eng"):
    ...
    raw_svg_file = Path(get_plots_path(), f"extra_4_hist_bins_{mode}.svg", bbox_inches='tight')
    final_plot = Path(get_plots_path(), f"extra_4_hist_bins_{mode}.png")
