...
def annotations_by_language(mode: str):
    ...
    return table_data, x_label, y_label


def plot_errors_plots(mode: str = "eng"):
    fontname = "Comic Sans MS"
    fontdict = {'fontsize': 14, 'fontname': fontname}
    table_data, x_label, y_label = annotations_by_language(mode)
    ...
    axs[0].scatter(good_prices, predicted_good, s=60, c="green",
    ...
    axs[1].scatter(bad_prices_first, predicted_bad_first, s=60, c="orange",
                   edgecolor="black", alpha=0.4)
    ...
    axs[2].scatter(bad_prices_second, predicted_bad_second, s=60, c="#ff8484",
                   edgecolor="black", alpha=0.4)
    ...
    plt.savefig(Path(get_plots_path(), f"10_datasets_actual_vs_predicted_{mode}.svg"))
    plt.close()
