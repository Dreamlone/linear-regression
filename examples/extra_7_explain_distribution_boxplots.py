...
def annotations_by_language(mode: str):
    if mode == "eng":
        title = "Boxplot"
        first_plot_title = "Original dataset"
        second_plot_title = "Kernel density estimation\nand frequency histogram (k = 10)"
        third_plot_title = 'Boxplot\n(vertical orientation)'
        median_label = "median"
    elif mode == "rus":
        title = "Ящик с усами"
...
def plot_distribution_boxplot(mode: str = "eng"):
    ...
    raw_svg_file = Path(get_plots_path(), f"extra_7_boxplot_explanation_{mode}.svg")
    final_plot = Path(get_plots_path(), f"extra_7_boxplot_explanation_{mode}.png")
