...
def annotations_by_language(mode: str):
    if mode == "eng":
        title = "Formulas for choosing the number of bins"
        first_plot_title = "Input data:\nsample size"
...
def plot_hist_bins_rules(mode: str = "eng"):
    ...
    raw_svg_file = Path(get_plots_path(), f"extra_5_hist_bins_rules_{mode}.svg", bbox_inches='tight')
    final_plot = Path(get_plots_path(), f"extra_5_hist_bins_rules_{mode}.png")
