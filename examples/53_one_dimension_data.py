...
def show_one_slice(mode: str = "eng"):
    ...
    x_green_left_left = float(intercept_values[idx_green_left - 1])
    ...
    ax_slice.text(x_green_left + 0.2, f_green_left - 0.3, f"{f_green_left:.1f}",
                  fontsize=10, fontname=FONTNAME, ha="center", va="bottom", color="black", zorder=6)
    # Green: difference to the left neighbour (no normalization)
    ...
    # The equation
    eq = r"$f_i - f_{i-1}$"
    ax_slice.text(0, 4.0, eq, fontsize=16, fontname=FONTNAME, ha="center", va="bottom",
    ...
    ax_slice.text(x_yellow_left - 0.2, f_yellow_left - 0.3, f"{f_yellow_left:.1f}",
                  fontsize=10, fontname=FONTNAME, ha="center", va="bottom", color="black", zorder=6)
    # Yellow: difference to the left neighbour (no normalization)
    ...
    circle = Circle((x_green_left_left, f_green_left_left), radius=0.1, fill=False, edgecolor="#15D600",
